...
import {ssz as focil} from "./focil/index.js";
import {ssz as phase0} from "./phase0/index.js";

export * from "./primitive/sszTypes.js";
export {phase0, altair, bellatrix, capella, deneb, electra, focil};
...
const typesByFork = {
  ...
  [ForkName.focil]: {...phase0, ...altair, ...bellatrix, ...capella, ...deneb, ...electra, ...focil},
};
